...
public:
	...
	void setCurrentValue(const String& attribute, float value, int level = 0, bool looted = false);
	void setCurrentValue(const String& attribute, float value, const float min, const float max, int level = 0, bool looted = false);
